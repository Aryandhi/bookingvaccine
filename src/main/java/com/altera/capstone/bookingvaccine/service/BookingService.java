...
public class BookingService {
  ...
  public ResponseEntity<Object> getBookingByUserId(Long id) {
    ...
    try {
      ...
      if (bookingDaoList.isEmpty()) {
        log.info("Booking id: {} not found", id);
        return ResponseUtil.build(AppConstant.Message.NOT_FOUND, "Booking not found, please check user_id",
  ...
  public ResponseEntity<Object> updateBooking(Long id, BookingDto request) {
    ...
    try {
      ...
      return ResponseUtil.build(AppConstant.Message.SUCCESS, mapper.map(bookingDaoOptional, BookingDto.class),
          HttpStatus.OK);
    } catch (Exception e) {
